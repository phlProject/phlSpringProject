...
<div id="content">
	...
	<div class="content-2">
		...
		<form id="idSearchForm" name="idSearchForm" >
			이&nbsp;&nbsp;&nbsp;&nbsp;름 : <input type="text" id="memNm" placeholder="이름" name="memNm"><br/>
		...
		<form id="pwSearchForm" name="pwSearchForm" ><br/>
			아이디	: <input type="text" 	id="memId" 		name="memId" onkeydown="engNumber(this)" placeholder="아이디" style="text-transform: lowercase;"><br/>
			이&nbsp;&nbsp;&nbsp;&nbsp;름 : <input type="text" 	id="memNm" 		name="memNm" placeholder="이름"> <br/>
			이메일	: <input type="text"	id="memEmail" 	name="memEmail" placeholder="이메일" onkeydown="notHangeul(this)"><br/>
