...
<div id="insertFormPop" class="insertLayer" style="display:none;">
	...
	<div class="divWrap mt15" id="monthDiv">
		<div class="btn-holder">    
			<a href="javascript:void(0)"><img src="/img/left_image.png" width="23px" alt="" style="padding-top:8px;" id="btnPrev"/></a>
			<span id='currentDate'></span>
			<a href="javascript:void(0)"><img src="/img/right_image.png" width="23px" alt="" style="padding-top:8px;" id="btnNext"/></a>
		</div>
